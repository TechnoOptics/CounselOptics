...
4. **Bella attach endpoint parses 10MB uploads unauthenticated** — `api/bella/attach`. No auth, no limit — DoS surface. **Fix:** require auth (401 otherwise) and/or IP-based rate limit + size cap.

...
const CONSUMER_TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      '50 cases or contracts (shared budget; vault sized in GB)',
      '1.5M Bella tokens / month (~37 sessions)',
...
const FIRM_TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      '8M Bella tokens / month per seat (firm pool)',

...
const EVENT_TONE: Record<CaseEventType, string> = {
  ...
  case_status_changed: 'bg-amber-500/10 text-warn-text ring-amber-500/30',
  case_deleted: 'bg-rose-500/10 text-danger-text ring-rose-500/30',
  exhibit_uploaded: 'bg-emerald-500/15 text-emerald-300 ring-emerald-500/30',
  exhibit_deleted: 'bg-rose-500/10 text-danger-text ring-rose-500/30',
  review_run: 'bg-gold-500/15 text-gold-300 ring-gold-500/30',
  hearing_updated: 'bg-amber-500/10 text-warn-text ring-amber-500/30',

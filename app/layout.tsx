...
// FooterCol moved to components/FooterCol.tsx (client component): the old
// inline <details open> rendered every section expanded on all viewports,
// which stretched the footer down the page on phones.

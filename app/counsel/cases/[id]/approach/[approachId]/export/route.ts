...
export async function GET(
  ...
  if (ctx) {
    ...
    // guest would otherwise pull the approach packet by URL. Same rule, same
    // reasons, as the evidence retrieval route, which states them at length:
    // guests only, after the access check, and never inside a catch.

  ...
  return (
    <div className="space-y-8 animate-fade-up">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="eyebrow mb-1">Counsel · contracts</p>
          <h1 className="font-display text-3xl font-medium tracking-[-0.01em] text-forest-900 dark:text-cream-100">
            Contract repository
          </h1>
          <p className="text-sm text-ink-600 dark:text-cream-100/70 mt-1 max-w-2xl leading-relaxed">
            Standalone contracts (not tied to a specific case). Useful for
            firm operating docs, vendor agreements, employment offers, and
            any document you want Bella to review in seconds.
          </p>
        </div>

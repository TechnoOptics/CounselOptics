...
export default function PrivacyPage() {
  return (
    <article className="max-w-3xl mx-auto prose-sm space-y-6 text-ink-800 leading-relaxed">
      <header>
        <p className="eyebrow mb-2">Privacy</p>
        <h1 className="text-3xl font-semibold tracking-tight text-forest-900">Privacy Policy</h1>

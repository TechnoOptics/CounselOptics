...
export function CaseMenu({
  ...
  const tile = (isActive: boolean) =>
    'group flex items-center gap-2.5 rounded-lg px-4 py-3 ring-1 text-foreground transition-all ' +
    (isActive
      ? 'bg-surface ring-gold-500/60 shadow-sm'
      : 'ring-transparent hover:bg-surface hover:ring-gold-500/60 hover:shadow-sm');
  ...
  return (
    <div className="-mt-1 space-y-4">
      <nav className="grid grid-cols-2 lg:grid-cols-4 gap-2 rounded-xl border border-edge bg-cream-50/70 dark:bg-forest-900/40 p-1.5">
        <Link
        ...
        >
          ...
          <span className="min-w-0">
            ...
            <span className="block truncate text-[11px] text-muted"><T>Build the story of events</T></span>
          </span>
        </Link>
        <Link
        ...
        >
          ...
          <span className="min-w-0">
            ...
            <span className="block truncate text-[11px] text-muted"><T>Search, review, share exhibits</T></span>
          </span>
        </Link>
        ...
        <a href={`/counsel/cases/${caseId}#case-approaches`} className={tile(false)}>
          ...
          <span className="min-w-0">
            ...
            <span className="block truncate text-[11px] text-muted"><T>Argue your theory from exhibits</T></span>
          </span>
        </a>
